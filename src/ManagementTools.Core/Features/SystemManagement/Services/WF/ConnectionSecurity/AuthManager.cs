...
internal static class AuthManager
{
    ...
    private const string ManagedAuthSetDisplayPrefix = "ManagementTools Connection Security";
    ...
    private static string BuildManagedAuthSetId(string ruleIdentity, bool phase1)
    {
        ...
        Guid guid = CreateDeterministicGuid($"ManagementTools.ConnectionSecurity.{prefix}.{ruleIdentity.Trim().ToUpperInvariant()}");
