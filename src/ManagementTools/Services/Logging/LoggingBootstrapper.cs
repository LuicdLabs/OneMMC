...
using System.Text;
using ManagementTools.Services.DependencyInjection;
...
public static class LoggingBootstrapper
{
    public static IServiceProvider BuildServiceProvider()
    {
        ...
        string appFolder = Path.Combine(localAppData, "ManagementTools");
        string logsFolder = Path.Combine(appFolder, "Logs");
        Directory.CreateDirectory(logsFolder);

        string logPath = Path.Combine(logsFolder, "managementtools-.log");
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .Enrich.WithProperty("Application", "ManagementTools")
            .WriteTo.File(
                path: logPath,
        ...
        services.AddManagementToolsApplicationServices();
