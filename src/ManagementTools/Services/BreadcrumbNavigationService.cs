...
namespace ManagementTools.Services
{
    ...
    public class BreadcrumbNavigationService
    {
        ...
        private static void LogDebug(string method, string message)
        {
            ...
            ManagementTools.Services.Logging.UiLogger.LogDebug($"[Breadcrumb][{method}] {message} | Crumbs=[{breadcrumbStr}] | {clickHistoryStr} | {mainNavHistoryStr} | {backStackStr} | State={CurrentState}");
        }
