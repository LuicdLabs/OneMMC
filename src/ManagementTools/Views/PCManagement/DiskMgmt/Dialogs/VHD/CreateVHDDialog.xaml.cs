...
public sealed partial class CreateVHDDialog : ContentDialog
{
    ...
    private async void BrowseButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        var selectedPath = await App.GetRequiredService<ManagementTools.Core.Abstractions.Services.IFileDialogService>().SaveFileAsync(
            hwnd,
        ...
        {
            App.GetRequiredService<ManagementTools.Core.Abstractions.Services.IFileDialogService>().CleanupPlaceholderFile(selectedPath);
