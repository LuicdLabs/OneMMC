...
public sealed partial class DtcTransactionListPage : Page
{
    ...
    {
        ManagementTools.Services.Logging.UiLogger.LogDebug("[DtcTransactionListPage] Loaded.");
        await ViewModel.LoadTransactionsAsync();
    }

    private async void RefreshButton_Click(object sender, RoutedEventArgs e)
    {
        ManagementTools.Services.Logging.UiLogger.LogDebug("[DtcTransactionListPage] Refresh requested.");
        await ViewModel.LoadTransactionsAsync();
    }
}
