...
/// </summary>
/// <remarks>
/// The service exposes only typed operations built by <see cref="IPSecurityCommandBuilder"/>.
/// It never accepts arbitrary command tokens.
/// </remarks>
public sealed class IPSecurityMutationService
{
    private readonly IPSecurityCommandExecutor _executor;

    /// <summary>
    /// Initializes a new instance of the <see cref="IPSecurityMutationService"/> class.
    /// </summary>
    /// <param name="executor">The restricted legacy static IPsec command executor.</param>
    public IPSecurityMutationService(IPSecurityCommandExecutor executor)
    {
        _executor = executor;
    }
    ...
    public Task AddPolicyAsync(IPSecurityPolicyCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildAddPolicy(options), cancellationToken);
    ...
    public Task SetPolicyAsync(IPSecurityPolicyCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildSetPolicy(options), cancellationToken);
    ...
    public Task AssignPolicyAsync(string policyName, bool isAssigned, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildAssignPolicy(policyName, isAssigned), cancellationToken);
    ...
    public Task DeletePolicyAsync(string policyName, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildDeletePolicy(policyName), cancellationToken);
    ...
    public Task AddFilterListAsync(IPSecurityFilterListCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildAddFilterList(options), cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IReadOnlyList<string> addListCommand = IPSecurityCommandBuilder.BuildAddFilterList(options);
        IReadOnlyList<IReadOnlyList<string>> addFilterCommands = filters
            .Select(IPSecurityCommandBuilder.BuildAddFilter)
            .ToList();
    ...
    public Task SetFilterListAsync(IPSecurityFilterListCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildSetFilterList(options), cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IReadOnlyList<IReadOnlyList<string>> deleteOriginalCommands = originalFilters
            .Select(IPSecurityCommandBuilder.BuildDeleteFilter)
            .ToList();
        IReadOnlyList<string> setListCommand = IPSecurityCommandBuilder.BuildSetFilterList(options);
    ...
    public Task DeleteFilterListAsync(string filterListName, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildDeleteFilterList(filterListName), cancellationToken);
    ...
    public Task AddFilterAsync(IPSecurityFilterCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildAddFilter(options), cancellationToken);
    ...
    public Task DeleteFilterAsync(IPSecurityFilterCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildDeleteFilter(ToFilterIdentity(options)), cancellationToken);
    ...
    public Task AddFilterActionAsync(IPSecurityFilterActionCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildAddFilterAction(options), cancellationToken);
    ...
    public Task SetFilterActionAsync(IPSecurityFilterActionCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildSetFilterAction(options), cancellationToken);
    ...
    public Task DeleteFilterActionAsync(string filterActionName, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildDeleteFilterAction(filterActionName), cancellationToken);
    ...
    public Task AddRuleAsync(IPSecurityRuleCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildAddRule(options), cancellationToken);
    ...
    public Task SetRuleAsync(IPSecurityRuleCommandOptions options, CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildSetRule(options), cancellationToken);
    ...
    public Task DeleteRuleAsync(
        ...
        string ruleName,
        CancellationToken cancellationToken = default)
        => ExecuteAsync(IPSecurityCommandBuilder.BuildDeleteRule(policyName, ruleName), cancellationToken);
