...
public sealed partial class LocalSecurityPolicyPage : Page
{
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[LocalSecurityPolicyPage] Initializing");
		InitializeComponent();
	}

	private void AccountPolicies_Click(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[LocalSecurityPolicyPage] Navigating to Account Policies");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[LocalSecurityPolicyPage] Navigating to Local Policies");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[LocalSecurityPolicyPage] Navigating to Network List Manager");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[LocalSecurityPolicyPage] Navigating to Public Key Policies");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[LocalSecurityPolicyPage] Navigating to Software Restriction");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[LocalSecurityPolicyPage] Navigating to IP Security");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[LocalSecurityPolicyPage] Navigating to System Audit");
