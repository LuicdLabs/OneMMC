...
namespace OneMMC.Views
{
    ...
    public sealed partial class SecurityPolicyEditorDialog : ContentDialog
    {
        ...
        {
            OneMMC.Services.Logging.UiLogger.LogDebug("[SecurityPolicyEditorDialog] Initializing");
            InitializeComponent();
        }
        ...
        {
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Setting policy: {policyValue.Definition.Key}, type={policyValue.Definition.PolicyType}");
            ...
            switch (policyType)
            {
                ...
                case SecurityPolicyType.Dropdown:
                    ...
                    {
                        OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Dropdown '{_policyValue.Definition.Key}' has no options; using fallback editor");
        ...
        private void ConfigureNumericEditor()
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Numeric editor: value={_policyValue.NumericValue}, range=[{_policyValue.Definition.MinValue}, {_policyValue.Definition.MaxValue}]");
        }
        ...
        private void ConfigureBooleanEditor()
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Boolean editor: value={_policyValue.NumericValue}");
        }
        ...
        private void ConfigureSingleStringEditor()
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] String editor: value='{_policyValue.StringValue}'");
        }
        ...
        private void ConfigureMultiStringEditor()
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] MultiString editor: value length={_policyValue.StringValue?.Length ?? 0}");
        }
        ...
        private void ConfigureAuditEditor()
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Audit editor: flags={flags}");
        }
        ...
        private void ConfigureUserRightsEditor()
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] User rights editor: {_accounts.Count} accounts");
        }
        ...
        private void ConfigureDropdownEditor()
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Dropdown editor: {_policyValue.Definition.DropdownOptions.Count} options, selectedIndex={selectedIndex}");
        }
        ...
        private void ConfigureBitmaskFlagsEditor()
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Bitmask flags editor: value={_policyValue.NumericValue}, options={BitmaskFlagsOptionsPanel.Children.Count}");
        }
        ...
        private void EditorSelectorBar_SelectionChanged(SelectorBar sender, SelectorBarSelectionChangedEventArgs args)
        {
            ...
            if (selectedItem?.Tag is string tag)
            {
                ...
                OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Tab switched to: {tag}");
            }
        }
        ...
        private void DefinePolicyCheckBox_Changed(object sender, RoutedEventArgs e)
        {
            ...
            OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Define policy checkbox changed: isDefined={isDefined}");
        }
            ...
            if (selections is { Count: > 0 })
            {
                foreach (var obj in selections)
                {
                    if (!string.IsNullOrWhiteSpace(obj.Name) && !_accounts.Contains(obj.Name))
                    {
                        ...
                        OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Added account: {obj.Name}");
                    }
                }
            }
        }
        ...
        private void RemoveAccountButton_Click(object sender, RoutedEventArgs e)
        {
            if (AccountsList.SelectedItem is string selected)
            {
                ...
                OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Removed account: {selected}");
            }
        }

        private void ContentDialog_PrimaryButtonClick(ContentDialog sender, ContentDialogButtonClickEventArgs args)
        {
            OneMMC.Services.Logging.UiLogger.LogDebug("[SecurityPolicyEditorDialog] OK clicked, collecting values");
            ...
            try
            {
                ...
                OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Collected value for '{_policyValue.Definition.Key}', isDefined={_policyValue.IsDefined}");
            }
            catch (Exception ex)
            {
                OneMMC.Services.Logging.UiLogger.LogDebug($"[SecurityPolicyEditorDialog] Validation error: {ex.Message}");
