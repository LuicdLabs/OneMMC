...
public sealed partial class CreateStoreDialog : ContentDialog
{
    ...
    private async void OnBrowseClick(object sender, RoutedEventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(result))
        {
            ...
            App.GetRequiredService<OneMMC.Core.Abstractions.Services.IFileDialogService>().CleanupPlaceholderFile(rawResult);
            App.GetRequiredService<OneMMC.Core.Abstractions.Services.IFileDialogService>().CleanupPlaceholderFile(result);
