...
public sealed partial class ComponentServicesPage : Page
{
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] Loaded.");
		if (_isInitialized)
		{
			return;
		}
	...
	private void UpdateCurrentMachineInfo()
	{
		...
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] Updated current PC label.");
	}

	private async Task RefreshComPlusSummaryAsync()
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] Refreshing COM+ summary...");
	...
	private async void OpenComexpLegacy_Click(object sender, RoutedEventArgs e)
	{
        ...
        catch (Exception ex)
        {
            ...
            {
                OneMMC.Services.Logging.UiLogger.LogDebug($"[ComponentServicesPage] Error opening comexp.msc: {ex.Message}");
            }
        }
    }
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] Refresh requested.");
		await RefreshComPlusSummaryAsync();
	}

	private async void ComPlusApplicationProperties_Click(object sender, RoutedEventArgs e)
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] COM+ Application Properties requested.");
		...
		{
			OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] Failed to get application info from Tag.");
			return;
		}
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] DCOM Config requested.");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] Running processes requested.");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] Transaction list requested.");
	...
	{
		OneMMC.Services.Logging.UiLogger.LogDebug("[ComponentServicesPage] Transaction statistics requested.");
