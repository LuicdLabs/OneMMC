using System;
using OneMMC.Core.Features.Certificates.Models;
...
public sealed partial class LocalComputerCertificatesPage : Page
{
    ...
    private readonly ILogger<LocalComputerCertificatesPage> _logger;
    ...
    public LocalComputerCertificatesPage()
    {
        ...
        _logger = App.GetRequiredService<ILogger<LocalComputerCertificatesPage>>();
        ViewModel = App.GetRequiredService<LocalComputerCertificatesViewModel>();
    ...
    public LocalComputerCertificatesViewModel ViewModel { get; }
    ...
    {
        _logger.LogError(ex, "Certificate operation failed on the local computer page.");
